...
const ScienceSubcategory = ({ subcategories, onSubcategoryClick, items }) => {
  ...
  return (
    <div>
      ...
      {/* Render ScienceItemDetails with filtered items */}
      {filteredItems.length > 0 && <ScienceItemDetails items={filteredItems} />}
    </div>
  );
};
