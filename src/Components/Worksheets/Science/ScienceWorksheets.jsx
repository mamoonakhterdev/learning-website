...
import science1 from '../../../assets/images/Science1.jpg'; // Update the image paths accordingly
        ...
        <Col xs={12} md={8}>
          <Box className="text-center my-4">
            ...
            <Typography variant="body1" paragraph>
              Explore our collection of Science worksheets designed to cover a broad range of topics including physics, chemistry, biology, and earth sciences. Our worksheets are crafted to engage students and enhance their understanding of various scientific concepts through various activities and exercises.
            </Typography>
